...
if __name__ == '__main__':
    ...
    infer_test = {}
    with open('prompt_mrc_result_prompt.txt', 'r', encoding="utf-8") as f:
        for data in f.readlines():
            info, raw_con, con = data.replace('\n','').split('\t')
            con = con.split(',')
    ...
    with open('forest_model_prompt.pickle','wb') as f:
        pickle.dump(forest,f)
    
    with open('prompt_forest.txt', 'w', encoding="utf-8") as f1:
