...
if __name__ == '__main__':
    dataset = {}
    with open('pre_test_forest_raw.txt', 'r', encoding="utf-8") as f:
    ...
    with open('pre_test_forest_raw.txt', 'w', encoding="utf-8") as f1:
        for info in dataset.keys():
